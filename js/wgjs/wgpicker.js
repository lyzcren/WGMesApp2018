...
(function($, document) {
	...
	var panelBuffer = '<div class="mui-poppicker">\
		<div class="mui-poppicker-header">\
			...
			<input type="text" class="mui-input-clear" placeholder="输入搜索内容">\
			<button class="mui-btn mui-btn-green mui-poppicker-btn-search">搜索</button>\
	...
	//定义弹出选择器类
	var WGPopPicker = $.WGPopPicker = $.Class.extend({
		//构造函数
